...
public class WheelMenu extends ImageView {
    ...
    public void wheelToRight()
    {
    	rotateWheel((float) (60));
    }
    public void wheelToLeft()
    {
    	rotateWheel((float) (-60));
    }
    ...
    public void onTouchMove(MotionEvent event)
    {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            double moveAngle = event.getY() - 200;
            //rotate the wheel by the difference
            rotateWheel((float) (moveAngle));
        ...
        case MotionEvent.ACTION_UP:
            ...
            //calculate the no of divs the rotation has crossed
            no_of_divs_crossed = (int) ((totalRotation) / divAngle);
            ...
            // inside the current top
            totalRotation = totalRotation % divAngle;
            System.out.println("Total Rotation= " + totalRotation +"top = " +top);
            ...
            if (snapToCenterFlag) {
                ...
                System.out.println("Total Rotation= " + totalRotation +" leftover = " +leftover);
